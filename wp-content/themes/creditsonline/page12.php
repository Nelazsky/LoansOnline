...
<div class="wrapper">
        ...
        <div class="topbar">
            <div class="container topbar-container">
                <div class="topbar-left-text">
                    <p>❌ НЕ БЕРИТЕ МИКРО КРЕДИТ, ЕСЛИ МОЖЕТЕ НЕ БРАТЬ</p>
        ...
        <div class="recommend">
            <div class="container recommend-container">
                <div class="recommend-inner-text">
                    Собираем ТОПовые микро кредит РФ в 1 месте. Для простых людей. Без впаривания, мошенников и кидал.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="container">
            <p>
                ❌ ВАЖНО
                ⭕ НЕ хотим подсаживать вас иглу на микро кредитов.
