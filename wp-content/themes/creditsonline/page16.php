        ...
        <div class="recommend">
            <div class="container recommend-container">
                <div class="recommend-inner-text">
                    Собираем ТОПовые Микрокредитные организации РФ в 1 месте. Для простых людей. Без впаривания, мошенников и кидал.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="container">
            <p>
                ...
                ⭕ Если Микрокредитная организация (МФО или МКК) не имеет лицензии ЦБ РФ - это мошенники
