...
<div class="wrapper">
        ...
        <div class="recommend">
            <div class="container recommend-container">
                <div class="recommend-inner-text">
                    Собираем ТОПовые онлайн займы РФ в 1 месте. Для простых людей. Без впаривания, мошенников и кидал.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="container">
            <p>
                ❌ ВАЖНО
                ⭕ НЕ хотим подсаживать вас иглу на онлайн микрозаймов и онлайн микрокредитов.
